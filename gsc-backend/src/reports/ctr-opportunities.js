  ...
  return {
    ...
    sections: [
      ...
      ...(opportunities.length > 0 ? [{
        ...
        type: 'note',
        text: '⚠ No CTR opportunities found in this period. This means either: (a) your page-1 queries are already hitting their CTR benchmarks (good!), or (b) you don\'t have many page-1 queries yet. Try a longer date range or check Content Gap Finder for page-2+ opportunities.',
      }]),
