...
2. You'll see a **Sign in** screen — type your `APP_PASSWORD` and click **Sign in** (NO browser popup — it's a proper form)
3. You'll land on the dashboard with a yellow banner: **"Not authorized yet"** → click **Authorize →**
...
The login form remembers you for **30 days** — no more being prompted on every page load. If you change `APP_PASSWORD` on Railway, everyone gets logged out and has to sign in again with the new password (this is intentional and safe).
